...
public class Segment {
    ...
    @Expose
    private List<Object> techStops = null;
    ...
    public String getSegmentCodeRef() {
        return segmentCodeRef;
    }

    public void setSegmentCodeRef(String segmentCodeRef) {
    ...
    public List<Object> getTechStops() {
        return techStops;
    }

    public void setTechStops(List<Object> techStops) {
