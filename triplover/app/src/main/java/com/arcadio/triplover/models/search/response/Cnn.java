...
public class Cnn {
    ...
    @Expose
    private List<TaxesBreakdown__1> taxesBreakdown = null;
    ...
    public List<TaxesBreakdown__1> getTaxesBreakdown() {
        return taxesBreakdown;
    }

    public void setTaxesBreakdown(List<TaxesBreakdown__1> taxesBreakdown) {
